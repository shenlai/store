...
namespace Store.Web
{
    public class StoreMembershipUser : MembershipUser
    {
        ...
        public StoreMembershipUser(string providerName,
            string name,
        ...
        public StoreMembershipUser(string providerName,
            ...
            :this(providerName, name, providerUserKey, email, passwordQuestion, comment, isApproved, isLockedOut,
