...
namespace Store.Web
{
    public class StoreMembershipProvider : MembershipProvider
    {
        ...
        private StoreMembershipUser ConvertFrom(UserDto userDto)
        {
            if (userDto == null)
                return null;
            var user = new StoreMembershipUser("StoreMembershipProvider",
                userDto.UserName,
                userDto.Id,
                userDto.Email,
                "",
        ...
        public StoreMembershipUser CreateUser(string userName,
            string password,
            string email,
            ...
            out MembershipCreateStatus status)
        {
            ...
            var user = GetUser(userName, true) as StoreMembershipUser;
            if (user == null)
            {
                ...
                return GetUser(userName, true) as StoreMembershipUser;
            }
            else
            {
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            if(String.IsNullOrEmpty(config["description"]))
            {
                ...
                config.Add("description", "Membership Provider for Store");
            }
